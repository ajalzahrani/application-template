      ...
      <main>
        <div className="container mx-auto max-w-screen-xl py-6 md:py-8 px-4">
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle>About the {APP_NAME}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p>
                  {APP_NAME} is a platform for creating and managing catoon
                  content. It is a simple and easy to use platform that you can
                  use to create your own catoon content.
                </p>
